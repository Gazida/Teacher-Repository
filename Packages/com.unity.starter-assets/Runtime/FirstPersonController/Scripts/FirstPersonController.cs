...
namespace StarterAssets
{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		private void Move()
		{
			...
			float targetSpeed = _input.sprint && manaEnough ? SprintSpeed : MoveSpeed; 
        ...
        public void SetManaEnough(bool newMana)
        {
            manaEnough = newMana;
            Debug.Log("Mana: " + manaEnough);
        }
        public bool GetManaEnough()
        {
            return manaEnough;
        }
